"""
Django settings for CiniCraft_WebServer project.
...
SECRET_KEY = 'f#)tfc@un=0l*qm@o&b!5+yrr48@0+d4@v0e+^1c+t#^@senqt'
...
ROOT_URLCONF = 'CiniCraft_WebServer.urls'
...
WSGI_APPLICATION = 'CiniCraft_WebServer.wsgi.application'
